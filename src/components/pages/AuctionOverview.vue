...
export default {
  data: () => ({
    ...
    contentList: [
      ...
      { titleYear: '2020 M-Benz', titleBrand: 'G-Class G500', description: '乍看全新G-Class的外觀設計，會發現在整體比例與線條的走向中，完全不改既有的經典初衷。但當仔細端倪，將會讚嘆原廠設計團隊的鬼斧神工，相較於先前車款，新G-Class的車身尺碼全面放大，以G 500車型為例，長/寬/高分別增加了53mm、117mm、15mm，軸距長度也拉長40mm，讓整體車身格局來到4817x1984x1969mm之譜，軸距長度則達到2890mm。不僅帶來更具份量感的視覺效果，對於乘坐空間也有實質助益，但不變的是，G-Class風靡車壇近40年的經典比例，完整延續。', milesT: '2000 Km', priceT: '2,300,000', id: '1' },
