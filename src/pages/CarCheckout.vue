<template>
  <div class="d-flex mt-12 ma-auto carcheckout">
    <div style="width:1000px">
      <img style="position: sticky;top:20%;left:15%" :src="imgsrc" alt="車圖" />
    </div>
    <div
          ...
          <div class="text-center mb-10">
            <v-dialog v-model="dialog" width="600">
              <template v-slot:activator="{ on, attrs }">
                <v-btn class="px-10 rounded-pill" color="orange darken-2" dark v-bind="attrs" v-on="on">
                  確認訂單
                </v-btn>
              </template>
